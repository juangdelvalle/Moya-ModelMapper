...
open class Endpoint<Target> {
    ...
    open func endpointByAddingParameters(_ parameters: [String: Any]) -> Endpoint<Target> {
        return endpointByAdding(parameters)
    }
    ...
    open func endpointByAdding(_ parameters: [String: Any]? = nil, httpHeaderFields: [String: String]? = nil, parameterEncoding: Moya.ParameterEncoding? = nil)  -> Endpoint<Target> {
...
extension Endpoint: Equatable, Hashable {
    public var hashValue: Int {
        return (urlRequest as URLRequest).hashValue
    }
}
